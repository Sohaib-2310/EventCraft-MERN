...
//     console.log('📦 New package booking submission:', req.body);
...
//     console.log('✅ Package booking saved to DB');

//     res.status(200).json({ success: true, message: 'Package booking submitted and saved!' });
//   } catch (error) {
